...
const MAX_SIZE = 10 * 1024 * 1024; // 10 MB fordi 1024 er riktig kilobyte - kibibyte
...
/* ── Hjelpere ─────────────────────────────────────────────────── */
function fmtSize(b) {
  /* Hvis b er mindre enn en MB returneres b/1024 som er antall kibibyte
    Hvis b er større enne en MB returneres b/(1024*1024) som er antall MB */
  return b < 1048576
    ? (b / 1024).toFixed(0) + ' KB'
